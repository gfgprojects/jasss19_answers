...
Unfortunately we have only two years of data after the ban and the reader should focus on comparing data from these two years. To make it happen we write ``world price would have been significantly lower in 2011-2013 \ldots''. Moreover we supply an explanation for constant prices at the end of the series stating that  ``the model outputs also the projection of prices for the following years. They are obtained under the simplification that produced and demanded quantity keep constant to the 2013 levels'' (paragraph 4.18).   
