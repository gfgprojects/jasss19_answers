...
The reviewer's comment made us realize that our effort in replicating average world prices brought a number of other qualitative results worth to be reported in the paper. In our opinion this has improved the insights obtained using the model. 
In particular, we realized that the qualitative results mainly concerns the quantity side of the model. Therefore, we redesigned the results section giving more space to the results on quantity. In our view, following the reviewer's recommendation we obtain the result s/he awaited: of balancing the paper result section between the quantitative results on prices and the qualitative results on quantities. 
